-- RFP estimated cost is maintained alongside tender values and must be available
-- to the pipeline list. A missing disclosure is represented as zero in the UI.

begin;

alter table public.agenttender_tenders
  add column if not exists rfp_estimated_cost numeric(20, 2);
